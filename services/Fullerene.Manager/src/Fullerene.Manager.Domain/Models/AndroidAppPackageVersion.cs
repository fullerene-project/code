...
public sealed class AndroidAppPackageVersion
{
    ...
    public AndroidAppPackage AndroidAppPackage { get; private set; }
    public NixPackageRepo NixPackageRepo { get; private set; }
    public NixRepoCommit NixRepoCommit { get; private set; }
    public ICollection<BuildWorkflow> BuildWorkflows { get; private set; }
}